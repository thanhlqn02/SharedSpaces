...
public class SharedSpacesVoip : MonoBehaviour
{
    ...
    [SerializeField] public SharedSpacesPlayerState playerState;
    ...
    public void StartVoip(Transform parent)
    {
        ...
        playerState = FindObjectsOfType<SharedSpacesPlayerState>().First(p => p.IsLocalPlayer);
...
/*        Debug.Log(playerState.NetworkObjectId);*/
